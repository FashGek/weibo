...
class PmController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			...
			array('allow', // allow authenticated user to perform 'create' and 'update' actions
				'actions'=>array('create','update', 'ajaxRouter'),
				'users'=>array('@'),
			),
	...
	{
		$dataProvider=new CActiveDataProvider('Pm');
	 ...
	 * @param Pm $model the model to be validated
	 */
	...
	public function actionAjaxGetList()
	{
		...
		$ret = $this->actionItemsToJSON($pms);
		echo $ret;
		Yii::app()->end();
	}

	public function actionItemsToJSON($items)
	{
		$ret = array();
